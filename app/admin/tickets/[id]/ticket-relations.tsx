...
const RELATION_TYPE_COLORS: Record<string, string> = {
  ...
  HAS_IDEA: 'bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-400',
  WILL_IMPLEMENT_AFTER: 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400',
  WILL_BE_IMPLEMENTED_BEFORE: 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400',
  ADDED_TO_ROADMAP: 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400',
  ROADMAP_INCLUDES: 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400',
